...
//                 <p>by-{author}</p>
//                 <p>Views: {viewers}</p>
//                 <p className="like-numbers">{likes}</p> {liked ? <i class="bi bi-hand-thumbs-up-fill like-fill" onClick={addLike}/> : <i className="bi bi-hand-thumbs-up like" onClick={addLike} />  }                                                                                     {disliked ? <i class="bi bi-hand-thumbs-down-fill dislike-fill" onClick={addDislike}/>: <i className="bi bi-hand-thumbs-down dislike" onClick={addDislike} />} <p className="dislike-numbers">{dislikes}</p>
//               </div>
