...
//     if (user && user.data) {
//       const fetchedUser = user.data.username;
//        fetchedPp= user.data.profilePicture
//       setCurrentUser(fetchedUser);
     

//     console.log("fetchedPp::::",fetchedPp);
...
//       <img src={fetchedPp} alt="" className="profile-pic"/>
...
//     if (user && user.data) {
//       const fetchedUser = user.data.username;
//       const fetchedPp = user.data.profilePicture;
      
//       setCurrentUser(fetchedUser);
//       setProfilePicture(fetchedPp);
...
//     <div className="profile-main">
//       {/* Profile Section */}
//       <img src={`http://localhost:4000/${profilePicture}`} alt="Profile" className="profilepic" />
//       <p className="welcome">{currentUser}</p>
...
//             <h1>No contributions yet!..</h1>
//             <p className="profile-tag">Be quick to make one...&#128522;</p>
//             <button className="profile-upload-btn" onClick={sent}>
//               Upload
//             </button>
//           </div>
//         )}
...
function Home() {
  ...
  return (
    <div className="profile-main">
      ...
      {profilePicture ? <img src={`http://localhost:4000/${profilePicture.replace(/\\/g, '/')}`} alt="Profile" className="profilepic" /> : <i class="bi bi-person-circle profilepic-icon"></i>}
